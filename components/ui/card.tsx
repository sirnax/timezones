  ...
  "rounded-lg border bg-card text-card-foreground shadow-xs",
  {
    variants: {
      variant: {
        ...
        "glass-light":
          "bg-black/4 backdrop-blur-xl border border-black/8 shadow-md [box-shadow:inset_0_0_0_1px_rgba(255,255,255,0.5)] text-gray-900",
        "glass-light-interactive":
          "bg-black/4 backdrop-blur-xl border border-black/8 shadow-md [box-shadow:inset_0_0_0_1px_rgba(255,255,255,0.5)] text-gray-900 transition-all duration-normal hover:bg-black/8 hover:border-black/15 hover:shadow-lg hover:-translate-y-0.5",
        ghost:
